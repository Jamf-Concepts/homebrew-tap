...
class Jamformer < Formula
  ...
  on_macos do
    url "https://github.com/Jamf-Concepts/jamformer/releases/download/v0.1.0/jamformer-0.1.0-darwin-universal.tar.gz"
    sha256 "f2066f3685d7257f14e59030aa12d3a14e13638f87c9d530c33a9d7da25e7685"
  end

  on_linux do
    on_intel do
      url "https://github.com/Jamf-Concepts/jamformer/releases/download/v0.1.0/jamformer-0.1.0-linux-amd64.tar.gz"
      sha256 "e955c4098ce8c39e79fbcdcda80f14ef8655102e44a049c70307d57c74a30259"
    end

    on_arm do
      url "https://github.com/Jamf-Concepts/jamformer/releases/download/v0.1.0/jamformer-0.1.0-linux-arm64.tar.gz"
